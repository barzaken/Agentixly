    ...
    return (
        <div>
            <div
                onClick={handleClick}
                className={cn(
                    "w-full max-w-xl p-1.5 rounded-2xl relative isolate overflow-hidden cursor-pointer",
...
const XCardDummyData = {
    link: "https://x.com/agentix_ui",
    authorName: "Agentix",
    authorHandle: "agentix_ui",
    authorImage: "/agentix-logo.png",
    content: [
        "Building beautiful UI components for modern web applications 🚀",
        "Check out our latest components and start building faster.",
    ],
    isVerified: true,
    timestamp: "Jan 18, 2025",
};
...
export default function XCardDemoDefault() {
